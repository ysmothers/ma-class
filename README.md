...
## Master Do File
Each of the relevant data sources are available individually and discussed in more detail below. Just scroll down to the [Raw Data Sources](https://github.com/imccart/Medicare-Advantage#raw-data-sources). All of these files can also be called as part of a master file, [_BuildFinalData.r](https://github.com/imccart/Medicare-Advantage/blob/master/data-code/_BuildFinalData.R) in R. I name these files so that they appear (by default) in Windows folders in a way that makes sense to me. So the master do file begins with an underscore, and the individual do files are numbered. This is just personal preference but helps me to keep things in order.
...
1. [Monthly Plan Enrollment Data](https://www.cms.gov/Research-Statistics-Data-and-Systems/Statistics-Trends-and-Reports/MCRAdvPartDEnrolData/Monthly-Enrollment-by-Contract-Plan-State-County.html)
   ...
   R script to organize CPSC enrollment data is available here: [1_Plan_Data.R](https://github.com/imccart/Medicare-Advantage/blob/master/data-code/1_Plan_Data.R)
...
2. [Plan Characteristics](https://www.cms.gov/Medicare/Prescription-Drug-Coverage/PrescriptionDrugCovGenIn/index)
   ...
   R script to organize plan premiums and other characteristics is available here: [2_Plan_Characteristics.R](https://github.com/imccart/Medicare-Advantage/blob/master/data-code/2_Plan_Characteristics.R)
...
3. [Service Area Files](https://www.cms.gov/Research-Statistics-Data-and-Systems/Statistics-Trends-and-Reports/MCRAdvPartDEnrolData/MA-Contract-Service-Area-by-State-County.html)
   ...
   R script to organize the service area files is available here: [3_Service_Areas.R](https://github.com/imccart/Medicare-Advantage/blob/master/data-code/3_Service_Areas.R)
...
4. [Penetration Files](https://www.cms.gov/Research-Statistics-Data-and-Systems/Statistics-Trends-and-Reports/MCRAdvPartDEnrolData/MA-State-County-Penetration.html)
   ...
   R script to organize the penetration files is available here: [4_Penetration_Files.R](https://github.com/imccart/Medicare-Advantage/blob/master/data-code/4_Penetration_Files.R)
...
5. [Star Ratings](https://www.cms.gov/medicare/prescription-drug-coverage/prescriptiondrugcovgenin/performancedata.html)
   ...
   R script to organize the star ratings data is available here: [5_Star_Ratings.R](https://github.com/imccart/Medicare-Advantage/blob/master/data-code/5_Star_Ratings.R)
...
6. [CMS Payment Data](https://www.cms.gov/Medicare/Medicare-Advantage/Plan-Payment/Plan-Payment-Data.html)
   ...
   [6_Risk_Rebates.R](https://github.com/imccart/Medicare-Advantage/blob/master/data-code/6_Risk_Rebates.R)
...
7. [MA Benchmark Rates](https://www.cms.gov/Medicare/Health-Plans/MedicareAdvtgSpecRateStats/Ratebooks-and-Supporting-Data.html)
   ...
   R script to organize the benchmark rates is available here: [7_MA_Benchmark.R](https://github.com/imccart/Medicare-Advantage/blob/master/data-code/7_MA_Benchmark.R)
...
8. [CMS Fee-for-service Costs](https://www.cms.gov/Medicare/Health-Plans/MedicareAdvtgSpecRateStats/FFS-Data.html)
   ...
   [8_FFS_Costs.R](https://github.com/imccart/Medicare-Advantage/blob/master/data-code/8_FFS_Costs.R)   